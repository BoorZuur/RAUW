...
class IssuePriorityResolver
{
     ...
     * their parent main category's priority via `parent_id`. Returns null when
     * the main category has no priority set. Reserved for future
     * participant-based priority adjustments.
     */
