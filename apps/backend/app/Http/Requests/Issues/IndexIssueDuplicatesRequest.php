...
class IndexIssueDuplicatesRequest extends FormRequest
{
    /**
     * The default number of duplicate children returned per page when `per_page`
     * is omitted.
     */
    ...
    /**
     * Only an authenticated, active officer or manager may list duplicate
     * children for a canonical issue.
     *
    ...
    /**
     * The validated, bounded number of duplicate children to return per page.
     */
