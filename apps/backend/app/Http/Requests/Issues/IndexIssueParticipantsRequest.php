...
class IndexIssueParticipantsRequest extends FormRequest
{
    /**
     * The default number of participants returned per page when `per_page` is
     * omitted.
     */
    ...
    /**
     * Only an authenticated, active officer or manager may list participants
     * for a canonical issue.
     *
    ...
    /**
     * The validated, bounded number of participants to return per page.
     */
