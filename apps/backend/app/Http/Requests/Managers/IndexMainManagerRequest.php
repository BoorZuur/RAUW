...
class IndexMainManagerRequest extends FormRequest
{
    /**
     * The default number of main managers returned per page when `per_page` is omitted.
     */
    ...
    /**
     * Only an authenticated, active main manager may list main managers.
     *
    ...
    /**
     * Validation rules for main-manager list pagination.
     *
    ...
    /**
     * The validated, bounded number of main managers to return per page.
     */
