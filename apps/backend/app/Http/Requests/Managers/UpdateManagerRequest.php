...
{
    /**
     * Only an authenticated, active main manager may update ordinary managers.
     *
    ...
    /**
     * Partial PATCH validation for ordinary-manager identity updates.
     *
    ...
    /**
     * The route-bound ordinary manager being updated.
     */
