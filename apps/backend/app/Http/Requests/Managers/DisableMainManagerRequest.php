...
class DisableMainManagerRequest extends FormRequest
{
    /**
     * Only an authenticated, active main manager may disable main managers.
     *
    ...
    /**
     * The route-bound main manager being disabled.
     */
