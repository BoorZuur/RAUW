                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        {fields.map((field) => (
                            <div key={field.id} className="text-left">
                                <label htmlFor={field.id} className="block text-xs font-bold tracking-wider uppercase mb-1.5 text-primary-text">
                                    {field.label}
                                </label>
                        ...
                        <div className="text-left">
                            <label htmlFor="department" className="block text-xs font-bold tracking-wider uppercase mb-1.5 text-primary-text">
                                Afdeling / Team
                            </label>
                            <div className="relative">
                                {loadingDepartments ? (
                                    <Loader2 className="absolute left-4 top-3.5 w-5 h-5 text-secondary-text animate-spin" />
                                ) : (
                                ...
                                >
                                    ...
                                    {departments.map((dept) => (
                                        <option key={dept.id} value={dept.id} className="bg-primary-bg-cards text-primary-text">
                                            {dept.name}
                                        </option>
                                    ))}
                                </select>
                                <div className="pointer-events-none absolute inset-y-0 right-4 flex items-center text-secondary-text">
