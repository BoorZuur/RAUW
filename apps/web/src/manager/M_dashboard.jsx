            ...
            <main className="main-content profile-container">
                ...
                <header className="profile-user-card">
                    <div className="profile-user-info">
                        <h2>Manager</h2>
                        <p className="profile-email">manager@rauw.nl</p>
                        <span className="profile-role-badge">Manager van de software</span>
                    </div>
                </header>
                ...
                <section className="profile-section">
                    <h3 className="section-title">Overzicht BOA team</h3>

                    <div className="activity-timeline-card">
                        <div className="timeline-empty-state">
                            <p>Geen toegewezen team</p>
                        </div>
                    </div>
                </section>
