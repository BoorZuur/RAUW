...
import ManagerAchtergrond from '../assets/ManagerAchtergrond.jpg';
...
export default function Login() {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col md:flex-row bg-primary-bg text-primary-text antialiased">
            ...
            <div className="hidden md:flex md:w-5/12 lg:w-1/2 relative flex-col justify-center items-center p-12 bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `linear-gradient(to bottom, rgba(18, 24, 32, 0.85), rgba(18, 24, 32, 0.95)), url('${ManagerAchtergrond}')` }}>
                ...
                <div className="max-w-md text-center text-white">
                    <h1 className="text-4xl lg:text-5xl font-headline tracking-tight leading-[1.15] mb-6">
                        Beheer je wijk<br/>met overzicht.
                    </h1>
                    <p className="text-sm lg:text-base font-body text-gray-300">
                        Log in op het managementportaal om actuele meldingen te monitoren, prioriteiten te stellen en de leefbaarheid in Rotterdam gericht te sturen.
                    </p>
                </div>
            </div>
