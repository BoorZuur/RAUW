            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 text-center md:text-left">
                ...
                <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-sm font-medium">
                        <li><a href="/feed" className="text-primary-text hover:text-primary-accent transition-colors">Home</a></li>
                        <li><a href="/meld" className="text-primary-text hover:text-primary-accent transition-colors">Melding doen</a></li>
                    </ul>
                </div>
